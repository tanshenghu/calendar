define("widget/calendar/1.0.0/calendar-debug", [], {
    handler: {
        getId: function(id) {
    ...
    createDate: function(date) {
        ...
        var coor = function(setData) {
            ...
            var nowDate = _this.handler.newDate(), Retain = _this.handler.retain, // 日期保留两位数
            nowYear = nowDate.getFullYear(), nowMonth = nowDate.getMonth() + 1, nowDate = nowDate.getDate();
            // 在title中显示 年份
    ...
    evt: function() {
        ...
        var pagingDate = function(btn_who) {
            ...
            // 需要填写第二个参数，将其设置为1号，否则会在当前是31号而下月只有30号的情况，有bug产生
            // 开始计算 翻日历
